    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ItemTouchHelper(object :
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                Toast.makeText(baseContext, "Obat dihapus!", Toast.LENGTH_SHORT).show()
            }
        }
        ...
        adapter.setOnItemClickListener(object : NoteAdapter.OnItemClickListener {
            override fun onItemClick(note: Note) {
                ...
                intent.putExtra(AddEditNoteActivity.EXTRA_KATEGORI, note.category)
                intent.putExtra(AddEditNoteActivity.EXTRA_INDIKASI, note.indication)
                intent.putExtra(AddEditNoteActivity.EXTRA_STOK, note.stock)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == ADD_NOTE_REQUEST && resultCode == Activity.RESULT_OK) {
            val newNote = Note(
                ...
                data.getStringExtra(AddEditNoteActivity.EXTRA_KATEGORI).toString(),
                data.getStringExtra(AddEditNoteActivity.EXTRA_INDIKASI).toString(),
                data.getIntExtra(AddEditNoteActivity.EXTRA_STOK, 1)
            )
            noteViewModel.insert(newNote)
            Toast.makeText(this, "Nama Obat Disimpan!", Toast.LENGTH_SHORT).show()
            ...
            Toast.makeText(this, "Nama Obat Tidak Disimpan!", Toast.LENGTH_SHORT).show()
        }
    }
}
